...
Для болле точно сравнения создадим таблицу с плюсами и минусами для каждого из веб-серверов Apache, Nginx и IIS, а затем оценим их суммарное количество и выберем лучший.
